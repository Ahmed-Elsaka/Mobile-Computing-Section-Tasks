...
public class GPSActivity extends AppCompatActivity {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        float X = intent.getFloatExtra(GPSService.X_VALUE, 0);
                        float Y = intent.getFloatExtra(GPSService.Y_VALUE, 0);
                        float Z = intent.getFloatExtra(GPSService.Z_VALUE, 0);
                        xtextview.setText( X +"" );
                        ytextview.setText( Y +"" );
                        ztextview.setText( Z +"" );
                    }
                }, new IntentFilter(GPSService.ACTION_GPS_BROADCAST)
        );
    ...
    public void saveOnclick(View view){
        ...
        //create an intent
        Intent SaveService = new Intent(getApplicationContext(),GPSService.class);
